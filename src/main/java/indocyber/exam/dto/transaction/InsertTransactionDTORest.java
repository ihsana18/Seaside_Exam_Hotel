...
public class InsertTransactionDTORest {
    ...
    public InsertTransactionDTORest(Integer id, LocalDate checkIn, LocalDate checkOut, String roomNumber, Integer customerId, BigDecimal bill, Boolean isPending, Boolean isExpired) {
        this.id = id;
